...
if __name__ == '__main__':
    stalk_time = 60 * 60 * 24
    print(stalk('89490983', stalk_time))  #средне групп
    # print(stalk('208905713', stalk_time))  # много групп
    # print(vkapi.get_groups(115938980))  # закрытые группы
    # print(vkapi.get_groups(71002319))  # закрытая страница
